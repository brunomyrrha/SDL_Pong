...
void Physic::InitBallMovement(Actor& a)
{
    srand(time(nullptr));
...
int Physic::DidScore(Actor& ball)
{
...
void Physic::CalculatePaddleHit(Actor& ball, Actor& computer, Actor& player)
{
